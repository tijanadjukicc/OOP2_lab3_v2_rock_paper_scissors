...
public class Papir extends Figura {
	...
	private int brojUglova = 4;
	private int xKoord[] = new int[brojUglova];
	private int yKoord[] = new int[brojUglova];
	public Papir(Vektor polozaj, Vektor pomeraj) {
		super(polozaj, pomeraj);
		// TODO Auto-generated constructor stub
	}

	public Papir(Vektor polozaj, Vektor pomeraj, Double r) {
	...
	public Figura stvoriFiguruisteVrste(Vektor polozaj, Vektor pomeraj, Double r) {
		return new Papir(polozaj, pomeraj, r);
	}

	@Override
	public boolean jacaJeOdZadate(Figura fig) {
		if(fig instanceof Disk) return true;
		else return false;
	}
